        ...
        <header class="card-header">
            <h4 class="card-title">
                @can('add_article_category')
                    <a href="{{ route('admin.article-category.create') }}" class="btn btn-primary text-white">New</a>
                @endcan
            </h4>
            <form action="{{ route('admin.article-category.index') }}" method="get">
                <div class="card-header-actions">
                    ...
                    <a href="{{ route('admin.article-category.index') }}" class="btn">Reset</a>
                </div>
            </form>
        </header>
                    ...
                    <tr>
                        ...
                        <td class="text-right table-options">
                            ...
                            @can('delete_article_category')
                                {!! Form::open(array('route' => array('admin.article-category.destroy', $post->id), 'method' => 'delete' , 'onsubmit'	=> 'return confirm("Are you sure you want to delete?");', 'style' => 'display: inline', '')) !!}

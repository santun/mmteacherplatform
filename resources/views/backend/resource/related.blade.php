...
@section('title', __('Related Resources'))
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="block-forms">
                        ...
                        @if (isset($post->id))
                        <form action="{{ route('admin.resource.add-related',$post->id) }}" method="post">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="{{ route('admin.resource.remove-related', [$resource->resource_id, $resource->related_resource_id]) }}"

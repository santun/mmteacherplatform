			...
			<div class="row">
				...
				<!--<div class="col-md-6 mb-md-0 mt-5">--> 
					...
					@foreach($preview_images as $image)
						...
						@if($image->getCustomProperty('iframe'))
							<div class="col-md-6 mb-md-0 mt-5">
								<a target="_blank" href="{{ $image->getUrl() }}" data-toggle="modal" data-target="#modal-iframe">{{ $image->file_name }}</a>
							</div>
						...
						@elseif(substr($image->mime_type, 0, 5) == 'image')
							<div class="col-md-6 mb-md-0 mt-5">
								<a target="_blank" href="{{ asset($image->getUrl()) }}" data-toggle="modal" data-target="#modal-image">
									{{ $image->file_name }}
							...
							<!------------------------------->
							<!--<div id="pdf">
							<object width="100%" height="1100px" type="application/pdf" data="{{-- URL::route('proposals.pdfviewer', $proposal->id) --}}"></object>
							</div> -->
							
							<!--<div id="pdf">							 
							<object width="100%" height="1100px" type="application/pdf" data="http://150.95.27.212/unesco_elibrary_v3/public/storage/184/Mathematics-Lesson-5.4.1-Learning-Material.pdf" ></object>
							</div>-->
						...
						<div class="col-md-6 mb-md-0 mt-5">
							<a target="_blank" href="{{ $image->getUrl() }}" data-toggle="modal" data-target="#modal-pdf">{{ $image->file_name }}</a>
						</div>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										@if(isset($image->getUrl()))
										<div id="pdf"> 							 
											<object width="100%" height="1100px" type="application/pdf" data="{{ $image->getUrl() }}" ></object>
										</div>
										@endif
									</div>
						...
						{{-- dd(pathinfo($image->getUrl(), PATHINFO_EXTENSION)) --}}
						<div class="col-md-6 mb-md-0 mt-5">
							<a target="_blank" href="{{  $image->getUrl() }}" data-toggle="modal" data-target="#modal-audio">{{ $image->file_name }}</a>
						...
						<div class="modal fade" id="modal-audio" tabindex="-1" role="dialog">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<iframe frameborder="0" width="400" height="200" src="{{ $image->getUrl() }}"> </iframe>
									</div>

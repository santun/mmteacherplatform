                            ...
                            <header class="card-header">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ route('member.course-approval-request.index') }}" class="btn">{{ __('Reset') }}</a>
                                    </div>
                                </div>
                                </form>
                            </header>
                                    ...
                                    @forelse ($posts as $post)
                                        <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center disabled">
                                            <div class="flex-column">
                                                ...
                                                <div class="mt-4">
                                                <a href="{{ route('member.course-approval-request.update-status', [$post->id, 'approve']) }}" class="btn btn-outline-success">
                                                {{ __('Approve') }}
                                                </a>
                                                <a href="{{ route('member.course-approval-request.update-status', [$post->id, 'reject']) }}" class="btn btn-outline-danger">
                                                {{ __('Reject') }}
                                                </a>
                                                </div>
                                                @endif
                                            ...
                                            <div class="image-parent">
                                                <img class="img-fluid" src="{{ asset($post->course->getThumbnailPath()) }}" alt="{{ $post->course->title }}" >

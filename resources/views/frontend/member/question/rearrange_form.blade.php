<!-- Rearrange Section Start-->
  <div id="rearrange">
      <div class="form-group">
          ...
          <input v-validate="'required'" type="text" placeholder="" name="answer_one" id="answer_one"
     ...
     <div class="form-group">
         ...
         <input v-validate="'required'" type="text" placeholder="" name="answer_two" id="answer_two"
     ...
     <div class="form-group">
         ...
         <input v-validate="'required'" type="text" placeholder="" name="answer_three" id="answer_three"
     ...
     <div class="form-group">
         <label for="answer_four" class="">@lang('4')  </label><span class="ml-1"> * </span>
         <input type="text" placeholder="" name="answer_four" id="answer_four"
             class="form-control summernote {{ $errors->has('answer_four') ? ' is-invalid' : '' }}"
     ...
     <div class="form-group">
         <label for="answer_five" class="">@lang('5')</label><span class="ml-1"> * </span>
         <input type="text" placeholder="" name="answer_five" id="answer_five"
             class="form-control summernote {{ $errors->has('answer_five') ? ' is-invalid' : '' }}"

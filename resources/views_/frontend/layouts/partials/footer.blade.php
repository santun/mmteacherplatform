        ...
        <div class="row gap-y align-items-center">
            <div class="col-lg-5">
                <div class="nav nav-trim justify-content-lg-center">
                    <a class="nav-link text-dark" href="{{ url(LaravelLocalization::setLocale().'/about-us') }}">{{ __('About Us') }}</a>
                    <a class="nav-link text-dark" href="{{ url(LaravelLocalization::setLocale().'/faq') }}">{{ __('FAQs') }}</a>
                    <a class="nav-link text-dark" href="{{ url(LaravelLocalization::setLocale().'/contact-us') }}">{{ __('Contact Us') }}</a>
                    <a class="nav-link text-dark" href="{{ url(LaravelLocalization::setLocale().'/disclaimer') }}">{{ __('Disclaimer') }}</a>
                </div>
            </div>
            <div class="col-12 col-lg-7 text-right order-lg-last">
                <div class="social">

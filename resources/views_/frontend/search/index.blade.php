...
<div class="section mb-0 pb-0">
    <header class="header text-white" style="background-color: #0069b4; padding-top:50px; padding-bottom:50px;">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="accordion accordion-connected border" id="accordion-1">
						<div class="card">
							<div class="card-title" style="background-color:#FFF">
								<a data-toggle="collapse" href="#collapse-subject" style="font-size:20px" class="collapsed">
								{{ __('Subjects') }}
								</a>
							</div>
					...
					<div class="accordion accordion-connected border" id="accordion-1">
                        <div class="card">
                            <div class="card-title" style="background-color:#FFF">
                                <a data-toggle="collapse" href="#collapse-format" style="font-size:20px" class="collapsed">
								{{ __('Resource Format') }}
								</a>
                            </div>
